<input id="pesquisaSlide" class="form-control left" placeholder="Pesquisar Produto ou " />
			  		...
			  		<tbody>
			  			<?php 
			  				$produtos = MySql::conectar()->prepare("
								SELECT idproduto, nome, qtd, preco_unit
								FROM tb_produto
			  				");
			  				$produtos->execute();
			    		...
			    		<tr>
				          	...
				          	<td>
				          		<form method="post" style="display: inline-block;">
				          			...
				          			<input type="hidden" name="acao" value="editarProd">
